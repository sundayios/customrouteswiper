...
import 'package:aoyanews/pages/news_tab/news_tab.dart';
import 'package:aoyanews/pages/alerts_tab/alerts_tab.dart';
import 'package:aoyanews/pages/market_tab/market_tab.dart';
import 'package:aoyanews/pages/strategy_tab/strategy_tab.dart';
...
class _HomePageState extends State<HomePage> {
  final _tabsData = <Tuple3>[
    ...
    Tuple3(Icons.home, "新闻".tr(), 0),
    Tuple3(Icons.new_releases, "快讯".tr(), 1),
    Tuple3(Icons.live_tv, "行情".tr(), 2),
    Tuple3(Icons.format_quote, "策略".tr(), 3),
    Tuple3(Icons.more, "我的".tr(), 4),
  ];
